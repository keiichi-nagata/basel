...
- [ ] 2026年9月号（北海道・お土産）を社長レビュー → note公開（下書き `omiyage/drafts/2026-09.md`・表画像・サムネ生成済み）
      → 温泉宿と同じマガジンに追加 → Threads/IG告知（承認フロー）→ `omiyage/published/2026-09.md` にURL記入
- [ ] 楽天アフィリエイトでお土産TOP5各商品の楽天市場リンクを発行 →「買う」欄に反映
