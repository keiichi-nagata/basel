...
- [x] `dev/1-apps/catalog.md` の元アプリのリポジトリ（ローカルパス）を記入
...
### マーケ部
- [ ] 次の自動投稿1〜2本を見て、ハッシュタグの「#」抜けが再発していないか確認（`ec3295b`の修正の効果チェック）
...
- [x] 2026-09-05 マーケ部 自動投稿のハッシュタグ「#」抜けを修正（プロンプト強化＋後処理での自動補正、`ec3295b`）
